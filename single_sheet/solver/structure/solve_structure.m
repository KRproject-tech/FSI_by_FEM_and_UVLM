...
%%[0] 流体力の線形補間 (Mf2_2)
Qf_p_global_t = (Qf_p_global - old_Qf_p_global)*(time - time_fluid)/d_t_wake + Qf_p_global_a;
h_Qf_p_global_t(:,i_time) = Qf_p_global_t;

%%[1] ( -(τx*dxΓ + τy*dyΓ)*dt_rc ) 
Qf_p_lift2_global_t = (Qf_p_lift2_mat_global - old_Qf_p_lift2_mat_global)*(time - time_fluid)/d_t_wake + Qf_p_lift2_mat_global_a;


%%[2] 付加質量マトリックスの線形補間 (Mf1)
Qf_p_mat_global_t = (Qf_p_mat_global - old_Qf_p_mat_global)*(time - time_fluid)/d_t_wake + Qf_p_mat_global_a;

%%[3] 流体力の線形補間 (Mf2_1)
Qf_p_mat0_global_t = (Qf_p_mat0_global - old_Qf_p_mat0_global)*(time - time_fluid)/d_t_wake + Qf_p_mat0_global_a;
...
[ X_vec_p, out1] = new_X_func_FAST( X_vec, M_global + J_global_1_n - Qf_p_mat_global_t, ...
                                    Qf_global + Qf_time_global*q_in_norm( time) + Qf_p_global_t + Qf_p_mat0_global_t_n + Qf_p_lift2_global_t_n,...
                                    dq_Qe_global_n, Qe_global_n + Qk_global_n, Qd_global_n + Qd_theta_global_n + J_global_2_n, var_param, 0, []);
...
new_X_vec = new_X_func_FAST( X_vec, M_global + J_global_1_n - Qf_p_mat_global_t, ...
                             ...
                             dq_Qe_global_n, Qe_global_n + (Qk_global_n + Qk_global_np1)/2, Qd_global_n + Qd_theta_global_n + J_global_2_n, var_param, 1, out1);
